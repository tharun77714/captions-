...
export const TEMPLATE_REGISTRY: Record<string, TemplateConfig> = {
  ...
  'neon-cyberpunk': tmpl('neon-cyberpunk', 'Neon Cyberpunk', 'viral', true, {
    font: { family: 'Montserrat', weight: 900, italic: false, underline: false, textTransform: 'uppercase' },
    fontSize: 120,
    letterSpacing: 4,
    lineSpacing: 1.1,
    textColor: { mode: 'solid', solid: '#06b6d4' },
    shadow: { color: 'rgba(6, 182, 212, 0.9)', blur: 48, offsetX: 0, offsetY: 0 },
    stroke: { enabled: true, color: '#000000', width: 3 },
    background: { enabled: true, color: 'rgba(15, 23, 42, 0.85)', opacity: 0.85, paddingX: 24, paddingY: 12, borderRadius: 12 },
    highlightMode: 'color',
  ...
  'tiktok-viral-yellow': tmpl('tiktok-viral-yellow', 'TikTok Viral Yellow', 'featured', true, {
    font: { family: 'Impact', weight: 900, italic: false, underline: false, textTransform: 'uppercase' },
    fontSize: 140,
    letterSpacing: 2,
    lineSpacing: 1.0,
    textColor: { mode: 'solid', solid: '#FFFFFF' },
    shadow: { color: 'rgba(0, 0, 0, 1)', blur: 20, offsetX: 6, offsetY: 6 },
    stroke: { enabled: true, color: '#000000', width: 6 },
    background: { enabled: false, color: 'rgba(0,0,0,0)', opacity: 0, paddingX: 24, paddingY: 12, borderRadius: 8 },
    highlightMode: 'karaoke',
    activeWordColor: '#facc15',
    inactiveOpacity: 0.4,
    transition: { type: 'bounce', target: 'word', speedMode: 'dynamic', speed: 18 },
  }),

  'minimal-vogue': tmpl('minimal-vogue', 'Minimal Vogue', 'minimal', true, {
    font: { family: 'Playfair Display', weight: 700, italic: true, underline: false, textTransform: 'none' },
    fontSize: 90,
    letterSpacing: 4,
    lineSpacing: 1.3,
    textColor: { mode: 'solid', solid: '#F8FAFC' },
    shadow: { color: 'rgba(0, 0, 0, 0.4)', blur: 16, offsetX: 0, offsetY: 2 },
    stroke: { enabled: false, color: '#000000', width: 0 },
    background: { enabled: false, color: 'rgba(0,0,0,0)', opacity: 0, paddingX: 24, paddingY: 12, borderRadius: 0 },
    highlightMode: 'color',
  ...
  'sam-sulek-raw': tmpl('sam-sulek-raw', 'Sam Sulek Raw', 'creator', true, {
    font: { family: 'Oswald', weight: 900, italic: false, underline: false, textTransform: 'uppercase' },
    fontSize: 130,
    letterSpacing: 4,
    lineSpacing: 1.0,
    textColor: { mode: 'solid', solid: '#FFFFFF' },
    shadow: { color: 'rgba(0, 0, 0, 0.95)', blur: 24, offsetX: 5, offsetY: 5 },
    stroke: { enabled: true, color: '#000000', width: 4 },
    background: { enabled: false, color: 'rgba(0,0,0,0)', opacity: 0, paddingX: 20, paddingY: 10, borderRadius: 6 },
    highlightMode: 'karaoke',
  ...
  'podcast-clean': tmpl('podcast-clean', 'Podcast Clean', 'professional', true, {
    font: { family: 'Outfit', weight: 700, italic: false, underline: false, textTransform: 'none' },
    fontSize: 96,
    letterSpacing: -1,
    lineSpacing: 1.2,
    textColor: { mode: 'solid', solid: '#FFFFFF' },
    shadow: { color: 'rgba(0, 0, 0, 0.6)', blur: 18, offsetX: 0, offsetY: 4 },
    stroke: { enabled: false, color: '#000000', width: 0 },
    background: { enabled: true, color: 'rgba(24, 24, 27, 0.9)', opacity: 0.9, paddingX: 28, paddingY: 14, borderRadius: 16 },
    highlightMode: 'color',
    activeWordColor: '#fbbf24',
    inactiveOpacity: 0.5,
    transition: { type: 'scale', target: 'word', speedMode: 'dynamic', speed: 22 },
  }),

  'cinema-gold': tmpl('cinema-gold', 'Cinema Gold', 'cinematic', true, {
    font: { family: 'Cinzel', weight: 800, italic: false, underline: false, textTransform: 'uppercase' },
    fontSize: 110,
    letterSpacing: 8,
    lineSpacing: 1.2,
    textColor: { mode: 'gradient', solid: '#fbbf24', gradientFrom: '#fef08a', gradientTo: '#d97706', gradientAngle: 90 },
    shadow: { color: 'rgba(0, 0, 0, 0.9)', blur: 32, offsetX: 0, offsetY: 4 },
    stroke: { enabled: true, color: '#451a03', width: 2 },
    background: { enabled: false, color: 'rgba(0,0,0,0)', opacity: 0, paddingX: 20, paddingY: 10, borderRadius: 6 },
    highlightMode: 'color',
    activeWordColor: '#ffffff',
    inactiveOpacity: 0.45,
  ...
  'synthwave-retro': tmpl('synthwave-retro', 'Synthwave Retro', 'viral', true, {
    font: { family: 'Permanent Marker', weight: 400, italic: false, underline: false, textTransform: 'none' },
    fontSize: 115,
    letterSpacing: 2,
    lineSpacing: 1.1,
    textColor: { mode: 'gradient', solid: '#ec4899', gradientFrom: '#f43f5e', gradientTo: '#a855f7', gradientAngle: 45 },
    shadow: { color: 'rgba(236, 72, 153, 0.8)', blur: 40, offsetX: 0, offsetY: 0 },
